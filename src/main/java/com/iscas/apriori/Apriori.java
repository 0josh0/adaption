...
public class Apriori {
    ...
    //MSF:最小支持度技术；MCONF：置信度
    @RequestMapping(value = "/getFrequentSets",method = RequestMethod.POST)
    public String doApriori(@RequestParam(value = "dataSetPath") String dataSetPath,@RequestParam(value = "frequentSetPath") String frequentSetPath,
                            @RequestParam(value = "MSF") Integer MSF,@RequestParam(value = "MCONF") Double MCONF,
                            @RequestParam(value = "rulesPath") String rulesPath) throws Exception {

        // 读取初始化数据集
        List<Set<String>> trans = new LinkedList<Set<String>>();
        ReadData readData = new ReadData();
        trans = readData.read(dataSetPath);
        ...
        writeData.write(frequentSetPath,rst,MCONF,rulesPath);
